...
namespace RabbitRegister.Model
{
    ...
    public class Yarn : Product
    {
        ...
        public Yarn(int productId, int breederRegNo, int yarnId, string productName, string fiber, double needleSize, double length, string tension, string washing, string color, int amount, int price) : base(productId, breederRegNo, productName, color, amount, price)
        {
            YarnId = yarnId;
            Fiber = fiber;
